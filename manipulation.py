...
def generate_data(n):
    # Return a list of tuples matching the table columns (except id)
...
plt.tight_layout()
plt.savefig("Images/batch_operations_cockroach.png", dpi=150)
plt.show()
...
plt.tight_layout()
try:
    plt.savefig("Images/single_operations_cockroach.png", dpi=150)
except: 
    pass
plt.show()
